...
class PlaceFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
            ...
            $place->setEmail('info@lanzarotepadelclub.com');
            $place->setTelephone('674374455');
            $place->setWhatsapp('674374455');
            $place->setFacebook('https://www.facebook.com/Lanzarote-Padel-Club-1431171980428161/');
            $manager->persist($place);

            $manager->flush();

            $place = new Place();
            $place->setName('Hyde Park Lane Padel Y Tenis');
            ...
            $admin = array('1','2');
            $place->setAdmin($admin);
            $place->setEmail('info@hydeparklanelanzarote.com');
            $place->setTelephone('123456789');
            $place->setWhatsapp('');
            $place->setFacebook('https://www.facebook.com/hydeparkpadel/');
            $manager->persist($place);
